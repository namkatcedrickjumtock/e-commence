...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:rgba(255,255,255,.55);width:240px;height:160px}' +
    ...
    '  background:#333;box-shadow:0 0 0 1.5px #888888,0 1px 3px rgba(0,0,0,.3);' +
    ...
    ':host([data-reframe]) .frame{box-shadow:0 0 0 2px #888888}' +
    ...
    '.empty:hover .sub u{color:rgba(255,255,255,.75);text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid #888888;outline-offset:-2px;' +
    '  background:rgba(255,255,255,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed rgba(0,0,0,.25);' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:#888888}' +
    ...
    '.err{position:absolute;left:8px;bottom:8px;right:8px;color:#ff6666;font-size:11px;' +
    '  background:rgba(0,0,0,.85);padding:4px 6px;border-radius:5px;pointer-events:none}';
